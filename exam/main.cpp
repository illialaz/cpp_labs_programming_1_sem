...
char* DayName(int num, int b, int num_of_days_per_week, struct Day* day) { // какой день соответствует числу num
...
int main(void) {
  ...
  struct Month months[20]; // хранилище месяцев
